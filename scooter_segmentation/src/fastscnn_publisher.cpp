    ...
    if(enableDepth) {
        ...
        if(depth_aligned) {
            ...
            if(enablenn) {
                ...
                // std::cout << "Type of previewQueue is: " << test_1<< std::endl;
                // std::cout << "Type of segmentationQueue is: " << test_2<< std::endl;
                ...
                // // std::cout << segmentationQueue->get<dai::NNData>()->getData() << std::endl;
        ...
        dai::rosBridge::BridgePublisher<stereo_msgs::msg::DisparityImage, dai::ImgFrame> dispPublish(
            stereoQueue,
            node,
            std::string("oak_d_pro/stereo/image_raw"),
