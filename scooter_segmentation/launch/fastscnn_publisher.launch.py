...
def generate_launch_description():
    ...
    enableSegmentation  = LaunchConfiguration('enableSegmentation', default = True)
    ...
    declare_enableSegmentation_cmd = DeclareLaunchArgument(
        'enableSegmentation',
        default_value=enableSegmentation,
        description='When enableSegmentation is enabled NN Object detection with Spatial Positioning will be run.')
    ...
    ld.add_action(declare_enableSegmentation_cmd)
